...
/// An [Observer] used by the [Presenter] to subscribe to a [UseCase].
/// Ideally, it would be implemented as an inner class inside the [Presenter].
/// But, until Dart supports inner classes,
...
abstract class Observer<T> {
  /// if the `Observable` emits a value
