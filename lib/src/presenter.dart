...
/// handles its creation and distruction.
/// A [Presenter] should be aggregated inside
/// a [Controller]. Its dependencies are also provided by the [Controller].
/// Once the [Controller] is disposed, it should also call [dispose()] of the
/// [Presenter] in order to dispose of the [UseCase].
/// The [Presenter] utilizes an [Observer] to listen to the
/// [UseCase]. However, it is a separate class since
/// Dart does not yet support inner
...
///       LoginPresenter(authenticationRepo): loginUseCase =
///           LoginUseCase(authenticationRepo);
///
///       /// login function called by the controller
///       void login(String email, String password) {
///         loginUseCase.execute(_LoginUseCaseObserver(this),
