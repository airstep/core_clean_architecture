...
import 'package:core_clean_architecture/src/view.dart';
...
class TestPage extends View {
  const TestPage({required this.controller, Key? key}) : super(key: key);
...
class _TestPageState extends ResponsiveViewState<TestPage, TestController> {
  ...
  Widget get desktopView =>
      Container(key: globalKey, child: const Center(child: Text('Desktop')));

  @override
  Widget get mobileView =>
      Container(key: globalKey, child: const Center(child: Text('Mobile')));

  @override
  Widget get tabletView =>
      Container(key: globalKey, child: const Center(child: Text('Tablet')));

  @override
  Widget get watchView =>
      Container(key: globalKey, child: const Center(child: Text('Watch')));
}
